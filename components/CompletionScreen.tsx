...
const CompletionScreen: React.FC<CompletionScreenProps> = ({ feedback, onContinue }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-lingo-card-bg">
      <Header title="Lingo" />
      <div className="flex-grow flex flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="text-3xl font-bold text-lingo-text mb-2">Session Complete!</h2>
        <p className="text-lingo-text-secondary">Great work today.</p>
        
        <div className="w-full max-w-xs mt-12 bg-lingo-bg p-4 rounded-2xl">
            <div className="flex justify-between items-end">
                <p className="text-lingo-text-secondary font-bold text-sm">BASE XP</p>
                <p className="text-xl font-bold text-lingo-text">{baseScore}</p>
            </div>
            ...
            <div className="flex justify-between items-end">
                <p className="text-lingo-text-secondary font-bold text-sm">TOTAL XP</p>
      ...
      <div className="p-6 border-t border-border-gray">
        <button
          onClick={onContinue}
          className="w-full bg-lingo-blue text-white font-bold py-4 px-4 rounded-xl hover:bg-lingo-blue-dark transition-colors text-lg"
        >
          Done
        </button>
      </div>
